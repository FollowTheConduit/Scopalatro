...
public:
	...
	{
		m_renderable.Translate (position);
	}

private:
	CardActor (CardColor color, CardSymbol symbol, TLOT::Renderable renderable):
		m_color {color}, m_symbol {symbol}, m_renderable {renderable}
	{
...
public:
	...
	CardActor Create (CardColor color, CardSymbol symbol);
